...
/**
  ...
  *@author bill
  */
public class JMenuActionOpenGDraw extends JMenuAction{
   /**Constructor for the save state object.
    * @param registeredObject The object to be registered with this menu action.
    */
   public JMenuActionOpenGDraw(GUI registeredObject) {
      super("Open Overlays",registeredObject);
   }
   ...
   public void run(){
      ...
      switch(returnVal) {
         case JFileChooser.APPROVE_OPTION:
            ...
            GDraw newGDraw = (GDraw)LibGUI.openStateFromFile(selectedFile);
            System.out.println(newGDraw);
            gui.getGMap().setGDraw(newGDraw);
            break;
